          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Checkbox
                ...
                className="border-muted-foreground data-[state=checked]:border-f1-neon data-[state=checked]:bg-f1-neon"
              />
              <Label
                htmlFor="remember"
            ...
            <Link
              to="/forgot-password"
              className="text-sm text-f1-neon transition-colors hover:text-f1-neon/80"
            >
              Forgot password?
            </Link>
          </div>
