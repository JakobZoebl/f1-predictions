...
const signupSchema = z
  .object({
    ...
    display_name: z.string().min(1, "Display name required").max(50),
...
5. **Email verification:**
   ...
   - Configure in Supabase Home → Authentication → Email Templates
...
1. **Enable in Supabase:**
   - Home → Authentication → Providers → Google
...
- Add all env vars in Vercel Home
